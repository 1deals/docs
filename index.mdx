---
title: Introduction
description: "Learn how to set up crave in your server or enhance your everyday use with commands & more."
...
<CardGroup cols={2}>
  <Card title="Server Configuration" icon="gear" href="/configuration/messages">
  ...
  <Card title="Embed Scripting" icon="code" href="/configuration/scripting">
